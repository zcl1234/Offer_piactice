...
//		BinaryTree b1=new BinaryTree(1,b2,b3);
		...
		//ReverseOrderTree(b1);
		//FloorOrderTree(b1);
		BinaryTree b4=new BinaryTree(7,null,null);
		BinaryTree b2=new BinaryTree(4,b4,null);
		BinaryTree b3=new BinaryTree(6,null,null);
		BinaryTree b1=new BinaryTree(5,b2,b3);
		ReverseOrderTree(b1);
	}
